...
/* OLED update flag (set in TIM3 ISR) */
...
int main(void) {
    ...
    snprintf(UART2_TX_buffer, sizeof(UART2_TX_buffer), "System Mode: %s", system_mode ? "CALIBRITION" : "MEASUREMENT");
    UART2_Log("INFO", "main.c", __LINE__, UART2_TX_buffer);
