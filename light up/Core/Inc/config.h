 ...
 *                     扫频参数配置
 * ========================================================= */
#define FREQ_SWEEP_START_HZ    10  // 扫频起始频率
#define FREQ_SWEEP_END_HZ      300 // 扫频结束频率
#define FREQ_SWEEP_STEP_HZ     2   // 扫频步进频率
#define FREQ_SWEEP_HOLD_TIME_S 5   // 每个频率停留时间(s)
...
#define DUTY_RATIO_SWEEP_HOLD_TIME_S 5   // 每个占空比停留时间(s)
